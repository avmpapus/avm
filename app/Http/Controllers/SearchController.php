...
$similar = Employee::where('title' ,'LIKE','% '.$search.' %')   
					   ...
					   /*
					   $image = Image::where('image' ,'LIKE','% '.$search.' %')	
...
return view('website.searchall',['posts'=>$posts],['similar'=>$similar]/*,['image'=>$image]*/);
//return view('post',['posts'=>$posts],['similar'=>$similar]/*,['image'=>$image]*/);
	}
