...
class UserProfileController extends Controller
{
    ...
    public function create(Request $request)
    {
     ...
     DB::update('update users_profiles set name=?,hobby=?,specialization=?,about=? where user_id = '.Auth::id(),[$name,$hobby,$specialization,$about,$user_id]);
	 ...
	 //return redirect()->back();
		...
		$profile->about = $request->about; //про меня
