...
class SearchUniController extends Controller
{



    
   public function searchalluni(Request $request)
    {
...
/*
   ...
   $aSearch = explode(" ", $search);
...

    {
        ...
        $posts = universology::where('title' , 'LIKE', ' %'.$search.'% ')

                       ->orWhere('email', 'LIKE', '%'.$request->searchString.'%')
					   
                       ->orWhere('htmlpost', 'LIKE', ' %'.$request->searchString.' %')		

                       //->orWhere('keywords', 'LIKE', '%'.$search.'%')					   
                       
                       ->get();

         view('website.searchalluni',['posts'=>$posts]);
...
$posts = universology::where('title' ,'LIKE','% '.$search.' %')
					 ...
					 //  print_r($posts); 
return view('website.searchalluni',['posts'=>$posts]);
	}
 /**
