...
<form id="form" action="{{action('EmployeeController@store')}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
    ...
    <input type="text" onkeyup="this.value=this.value.replace(/^\s/,'')" name="title" class="form-control" placeholder="Название сайта или поста"  required autofocus>
  </div>
    ...
    <textarea name="email" placeholder="Описание" cols="106" rows="5" style="display: inline-block;
  background: #f1f1f1; border-radius:2%; border: 1px solid #BDBDBD;" onkeyup="inputValidateW(this.val)" id="tagw" maxlength="1500" required></textarea>
...
<div id="id"></div>
<div id="error2"></div>
<script src="/assets-front/js/inputValidateW.js"></script>
   <br><br><br>
