...
$search = $_GET['search'];
?>
<title><?php echo $search; ?> - Поиск в Go3</title>
...
<div style="position:relative; top:2px; left: 2px;"><font size="3">
По причине отрицательного результата, Go3 перевел вас на страницу Google
</font>
</div>
</div>
<?php
...
if ($mobile_browser > 0) {
	?>
	<div style="position:relative; top:2px; left: 2px; width:100%;"><font size="3">
Ничего не найдено по вашему запросу,<br>Go3 перевел вас на страницу Google
</font>
</div>
<?php
}
