		...
		<form role="form" id="form-news-sk" action="{{action('NewsController@storeNews')}}"
                        ...
                        <div class="for-large-screens">
                            ...
                            echo '<a href="../user/'.$user_profile->user_id.'"><img src="/assets-front/img/no-avatar.jpg" width="45" height="45"
                                     style="border-radius: 50%;" class="leftimg" title="Мой профиль"></a>';
                            }else{
						...
						{
							echo'<font color="green">Щоб завантажити фото, натисніть на <b>Выберите файл</b> або перетягніть фото мишкою на напис <b>Выберите файл</b> або <b>Файл не выбран, після чого, натисніть на Зберегти</font>';
						}
						?>
                        <br><br>
