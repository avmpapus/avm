<div class="for-large-screens">
    ...
    <div style="position: fixed; top:7px; margin-left:75px; z-index:2; width:2000px;">
		...
		<div style="position: fixed; top:15px; z-index:2;margin-left:522px;">
		<a href="../mycity"><font color="white">Мой родной край</font></a>&nbsp;&nbsp;&nbsp;
		</div>
		
		
				<div style="position: fixed; top:15px; z-index:2;margin-left:654px;">
		<a href="../maps"><font color="white">Карты</font></a>&nbsp;&nbsp;&nbsp;
		</div>

		<div style="position: fixed; top:12px; z-index:2;margin-left:715px;">
		<a href="../etimology"><font color="white">Этимология</font></a>&nbsp;&nbsp;&nbsp;
...
<div class="for-small-screens">
    ...
    <div style="position: fixed; top:7px; margin-left:20px; z-index:2; width:900px;">
    ...
    <div style="position: fixed; top:0px; left:282px; z-index:2;">
        &nbsp;&nbsp;&nbsp;
        <a href="{{ url('/message') }}" class="a-badge-mess">
            <img src="{{asset('assets-front/img/message_.png')}}" width="42"
                 class="{{ isset($count_mess)&& $count_mess>0 ? 'com-anime' : '' }}"
    ...
    <div style="position: fixed; top:0px; z-index:2;margin-left:230px;">
