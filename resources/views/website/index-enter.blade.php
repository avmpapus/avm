...
<div id="openModal" class="modalDialog">
	<div>
		...
		<h2>Все фильмы на Seria-Z, а также научные и научно-популярные</h2>
   <?php
...
<div class="col-md-6 col-sm-6 col-xs-12 sk-block">
        ...
        <div style="margin:10px;padding:10px;background:white;">
                @if(!auth::id())
				Войдите или зарегистрируйтесь чтобы опубликовать материал
			    @endif
                    ...
                    <a href="javascript:onoff('div1');">
                        ...
                        <option>Личное</option>
                            ...
                            <div class="form-group">
                                ...
                                if($user_profile->language!='ua'){
                                ?>
								<font color="green">Чтобы загрузить фото, нажмите на <b>Выберите файл</b> или перетащите фото мышкой на надпись <b>Выберите файл</b> или <b>Файл не выбран</b>, после чего, нажмите на Сохранить</font>
                                @if ($errors->has('img2'))
                                    <span class="help-block">
                            <strong>{{ $errors->first('img2') }}</strong>
								...
								<font color="green">Щоб завантажити фото, натисніть на <b>Выберите файл</b> або перетягніть фото мишкою на напис <b>Выберите файл</b> або <b>Файл не выбран, після чого, натисніть на Зберегти</font>
                                @if ($errors->has('img2'))
                                    <span class="help-block">
                            <strong>{{ $errors->first('img2') }}</strong>
                        </span>
...
@foreach($posts as $one_post)
	       @if($one_post->pub!='Личное')
			   ...
			   <div class="sk-div-post" data-id = "{{ $one_post->id }}" style="margin:10px;padding:10px;background:white;">
...
<div class="col-md-3 col-sm-3 col-xs-12 sk-block">
   ...
   $url = $_SERVER['REQUEST_URI'].'?lang=eng&type=set';
    ...
    <div style="background-color:#fff;padding:10px;margin:-10px;margin-top:10px;margin-left:-30px;">
	{{---
        Наука
    <br>
	...
	<?php
            if($a=='/posts' and $a!='../user/14/edit'){
				?>
				Реклама
	<br>
	<br>
	<img src="assets-front/img/bnr-ukr.jpg" width="264">
		<br>
	<br>
	<a href="http://elvira.cn.ua"><img src="assets-front/img/elvira1.jpg" width="264"></a>
	<br><br>
	<a href="http://elvira.cn.ua/servis"><img src="assets-front/img/elvira2.jpg" width="264"></a>
	<br><br>
