...
<div class="col-md-6 col-sm-6 col-xs-12 sk-block">
    <div class="midcont">
        ...
        <div style="margin:-10px;padding:10px;">
            ...
            &nbsp;
                    ...
                    <a href="{{action('GroupsController@create')}}">
                        <font color="">Создать проект/группу</font>
                    </a>
                    <?php
                    }
                    if($user_profile->language=='ua'){
                    ?>
                    <a href="{{action('GroupsController@create')}}">
                        <font color="">Створити проект/групу</font>
                    </a>
                    <?php
                    }
                    ?>
                        ...
                        <option>Личное</option>
                            ...
                            <span class="text-danger">
                                <i class="fa fa-youtube-play fa-lg" aria-hidden="true"></i>
                                    ...
                                    <hr>
                                    &nbsp;&nbsp;&nbsp; Для этого нужно на интересующем Вас видео на сайте
                                    <a href="https://www.youtube.com/" target="_blank">
                            <span class="text-danger">
                                <i class="fa fa-youtube-play fa-lg" aria-hidden="true"></i>
                            </span>
                                    ...
                                    нажать правой кнопкой мышки и выбрать <strong class="text-warning">Копировать HTML код</strong>, и после <strong class="text-warning"> вставить</strong> в поле ниже.
                                    <hr>
                                </label>
                            ...
                            <span class="text-danger">
                                <i class="fa fa-youtube-play fa-lg" aria-hidden="true"></i>
                                    ...
                                    <code>&lt;iframe&gt;....&lt;/iframe&gt;</code> .
                                    <hr>
                                    &nbsp;&nbsp;&nbsp; Для цього потрібно на відео, яке Вас зацікавило на сайті
                                    <a href="https://www.youtube.com/" target="_blank">
                            <span class="text-danger">
                                <i class="fa fa-youtube-play fa-lg" aria-hidden="true"></i>
                            </span>
                                    ...
                                    натиснути правою кнопкою мишки і вибрати <strong class="text-warning">Копіювати HTML код</strong>, і після <strong class="text-warning">Вбудувати</strong> в поле нижче.
                                    <hr>
                                </label>
                                <input type="text" name="video_link" class="form-control" value="{{ old('video_link') }}"
        ...
        <div style="margin:10px;padding:10px;" class="bg-warning">
            <h4 class="text-center">
                {{$category_current->page}}
            </h4>
        </div>
    ...
    @if(!$posts->isEmpty())
        ...
        <div class="sk-div-post" data-id = "{{ $one_post->id }}">
            ...
            <?
            /*вывод пользователей интересующихся темой опубликованной ее автором*/
            /*
            $db = mysqli_connect('mysql317.1gb.ua','gbua_cpil_new','dffd9d06qw','gbua_cpil_new')or die('Ошибка соединения с БД');
            //$db = mysqli_connect('localhost','root','','gbua_cpil_new')or die('Ошибка соединения с БД');
            if(!$db) die (mysql_connect_error());

            $res = mysqli_query($db, "select * from search_probe where subcategory_id");
            $data = mysqli_fetch_all($res, MYSQLI_ASSOC);
            echo'Этой темой интересуются: ';
            foreach ($data as $item){
                //echo '<a href="/user/'.$item['id_user'].'"">'.$item['user_name'].'</a>, ';
            }
            */
...
?>
                ...
                <div class="col-md-2">
                    <p class="text-right">
                        <a href="{{ action('PostController@edit', $one_post->id) }}">
                            ...
                            ?>
                                <i class="fa fa-pencil-square-o fa-lg sk-fa-edit" aria-hidden="true"
                                   data-toggle="tooltip" data-placement="top" title="Редактировать текст"></i>
                            <?php
                            }
                            if($user_profile->language=='ua'){
                            ?>
                                <i class="fa fa-pencil-square-o fa-lg sk-fa-edit" aria-hidden="true"
                                   data-toggle="tooltip" data-placement="top" title="Редагувати текст"></i>
                            <?php
                            }
                            ?>
                        ...
                        <a href="{{ action('PostController@delPost', $one_post->id) }}">
                            ...
                            ?>
                                <i class="fa fa-trash-o fa-lg sk-fa-del" aria-hidden="true"
                                   data-toggle="tooltip" data-placement="top" title="Видалити"></i>
                            <?php
                            }
                            ?>
            ...
            $query = "SELECT * FROM search_probe where subcategory_id=$one_post->subcategory_id";
    ...
    if($user_profile->language!='ua'){
        ...
        echo '<font color="gray">Этой темой интересуются:</font>&nbsp';
            }
            else
                {
                echo '<font color="gray">Цією темою цікавляться:</font>&nbsp';
            }
                ...
                while ($row = $result->fetch_assoc())
                    ...
                    echo "<a href='../user/".$row['id_user']."'>".$row['last_name']."</a>&nbsp";
			...
			*/
            ...
            ?>
            <font color="gray">
                Підтема: <a href="{{ $one_post->page }}">{{ $one_post->category }}</a>
            </font>
            <?php
            }
            ?>
            ...
            <div class="col-xs-12" style="margin-bottom: 10px;">
                <table class="table-like">
                    <tr>
                        <td class="td-one-sk">
                            ...
                            ?>
                                ...
                                <a href="#" class="sk-very-like" tabindex="0" data-trigger="focus" onclick="return false;">
                                    {{ $one_post->like_arr['ve'] }}
                                </a>
                            <?php
                            }
                            if($user_profile->language=='ua'){
                            ?>
                                <input type='image' src='{{asset('assets-front/img/very_like.png')}}' value='Не подобається'
                                       data-toggle="tooltip" title="Дуже подобається"
                                       name='submit_very_likes' width='20' class="radius_unlikes"
                                       data-id = "{{-- $one_post->id --}}" data-like="1"
                                       onclick="return false;" onFocus="this.blur();"/>
                        ...
                        ?>
                        <td class="td-one-sk">
                            <input type='image' src='{{asset('assets-front/img/like.png')}}' value='Нравится' data-toggle="tooltip" title="Нравится"
                        ...
                        ?>
                        <td class="td-one-sk">
                            <input type='image' src='{{asset('assets-front/img/like.png')}}' value='Подобається' data-toggle="tooltip" title="Подобається"
                                   name='submit_likes' width='20' class="radius_unlikes"
                                   data-id = "{{-- $one_post->id --}}" data-like="2"
                                   onclick="return false;" onFocus="this.blur();"/>
                        ...
                        ?>
                        <td class="td-one-sk">
                            <input type='image' src='{{asset('assets-front/img/unlike.png')}}' value='Не подобається' data-toggle="tooltip" title="Не подобається"
                                   name='submit_unlikes' width='20' class="radius_unlikes"
                                   data-id = "{{-- $one_post->id --}}" data-like="3"
                                   onclick="return false;" onFocus="this.blur();"/>
            ...
            {{--@if($user_profile)--}}
            @if(!Auth::user()->profileForUser()->get()->isEmpty())
    ...
    @else
        <div style="margin:10px;padding:10px;background:#f0f0f0;">
            ...
            ?>
                <p class="text-center text-danger">
                    У цій категорії немає матеріалів
                </p>
            <?php
            }
            ?>
...
if($user_profile->language!='ua'){
        ...
        echo'
<div style="margin-left: -40px;background-color:#fff;padding:10px;">
<a href="http://cpcp.com.ua/ua" id="post_form_language">Українська</a>';
...
<font color="gray">Українська</font>';
        echo'<br><a href="http://cpcp.com.ua/ru" id="post_form_language">Русский</a>
</div>';
    }
	*/
    ?>
