...
<input type="text" onkeyup="this.value=this.value.replace(/^\s/,'')" placeholder="Ваш вопрос...!" name="searchString" id="searchString" style="width:700px" onchange="verifyIt(this); verifyCyrillic(this); verifySynonyms(this);" value="">
...
<center>
 <div align="justify" style="width:500px;">
  ...
  @endif
    @if($post->image=='/public/assets-front/img/post/favicon.png')
  <img src="/public/assets-front/img/post/not-img.png">
  @endif
  <br>
	  ...
	  <br>
	  <a href="/post/{{$tit = $post->id}}">Посмотреть страницу</a> Комментировать <img src="/public/assets-front/img/smile/5853f52df07d415907f5bba1.png" width="25">1 <img src="/public/assets-front/img/smile/agre.png" width="25">1



  <div style="position:relative; top:-69px; left:225px;">{{$tit = $post->like}}</div>
  <div style="position:relative; top:-88px; left:378px;">{{$tit = $post->notlike}}</div>
</div>	  
</center>
<?php
}
...
<form id="form" action="{{action('NotLikesController@notlikesstore')}}" method="POST" enctype="multipart/form-data">
