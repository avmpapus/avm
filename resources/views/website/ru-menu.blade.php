...
<?php
            ...
            <?php
            if($a=='/user/'.$user_profile->user_id){
?>

<div class="right-a-sk">
    Наука
    <br>
...
<div class="right-a-sk">
    ...
    <br>
    <a href="../posts-for-cat/25">Наука</a>
    <a href="../posts-for-cat/24">Наука і дослідження</a>
    <a href="../posts-for-cat/1">Громадські та гуманітарні науки</a>
    <a href="../posts-for-cat/2">Природні науки</a>
    <a href="../posts-for-cat/3">Технічні науки</a>
    <a href="../posts-for-cat/4">Технічні експерименти, прикладні дослідження</a>
    <a href="../posts-for-cat/5">Дослідження, експерименти</a>
    Энергія
    <br>
    <a href="../posts-for-cat/6">Енергозберігаючі технології</a>
        Побут
        <br>
    <a href="../posts-for-cat/7">Побутові, технічні експерименти, саморобки</a>
        Будівництво
        <br>
    <a href="../posts-for-cat/8">Капітальне будівництво</a>
        <a href="../posts-for-cat/9">Ландшафтне будівництво</a>
        <a href="../posts-for-cat/10">Ландшафтний дизайн</a>
        Культура
        <br>
        <a href="../posts-for-cat/11">Искусство</a>
        <a href="../posts-for-cat/12">Религия</a>
        Экологія
        <br>
        <a href="../posts-for-cat/13">Ліс, паркове господарство</a>
        <a href="../posts-for-cat/14">Річки, водні системи, берегові зони</a>
        <a href="../posts-for-cat/15">Природні ресурси</a>
        Суспільство
        <br>
        <a href="../posts-for-cat/16">Моделі комунікації</a>
        <a href="../posts-for-cat/22">Інформаційні технології</a>
        <a href="../posts-for-cat/17">Національна ідея, формування національної ідеї</a>
        <a href="../posts-for-cat/18">Система громадського самоврядування (СіОС)</a>
        Освіта
        <br>
        <a href="../posts-for-cat/19">Освіта, самоосвіта</a>
        Ідеї
        <br>
