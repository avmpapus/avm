...
<form id="form" action="{{action('LikesController@LikesStore')}}" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="title" class="form-control" placeholder="Название сайта или поста" autofocus>
  </div>


    <textarea name="email" class="form-group"  placeholder="Описание" cols="109" rows="5" style="display: inline-block;
