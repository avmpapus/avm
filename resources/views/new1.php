...
<br><br><br><br>
{{-------{{action('SearchController@searchall')}}-------}}
<form class="example" name="search" action="{{action('SearchController@searchall')}}" style="margin:auto;max-width:300px">
{{ csrf_field() }}
  <input type="text" placeholder="!Ваш вопрос..." name="searchString" id="tags">
