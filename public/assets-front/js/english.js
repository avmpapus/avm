                  ...
                  var aString = string.split(' '); 
                   ...
                   {                        
...

                        {
                            ...
                            //---   Если попалось русское слово, делаем проверку Английского слова ---
                        ...
                        // проверка последнего английского слова 

                        english = english.trim();

//                        alert('Проверяем ' + english + english.length + aEnglish.indexOf(english));

                        if (aEnglish.indexOf(english) == -1 && english.length != 0)

                        {

                            alert('Недопустимое слово -2 ' + english);
